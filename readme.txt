...
The first line of the dataset contains two values which correspond to the size and the dimensionality of the dataset. Then, starting from the second line of the file, each line corresponds to a tuple/point in the dataset.
